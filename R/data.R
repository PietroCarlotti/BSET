...
#'
#' A dataset containing the grid of simulation results for Carlotti and Parast (2026).
#'
...
#' }
#' @source Computed using \code{Carlotti_and_Parast_2026_simulations(seed = 123, n_simulations = 500)}.
