...
The DCCT data were obtained from the NIDDK Central Repository (NIDDK-CR) and are available to researchers upon request to NIDDK-CR. The \texttt{BSET} R package and reproduction code are at \url{https://github.com/PietroCarlotti/BSET}.
