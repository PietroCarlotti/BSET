...
```{r quick-start-no-X-show, echo=FALSE, fig.width=8, fig.height=4.5, fig.align='center', fig.cap="Posterior distribution of $\\theta$ from `BSET` without covariates."}
