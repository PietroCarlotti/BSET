...
If the data do not include baseline covariates, we can run the BSET procedure by fitting the following Bayesian model:
\begin{align*}
  (Y_i, S_i) = \begin{cases}
    (Y_i(0), S_i(0)) & \text{if } Z_i = 0 \\
    (Y_i(1), S_i(1)) & \text{if } Z_i = 1
